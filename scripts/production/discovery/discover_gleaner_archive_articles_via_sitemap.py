...
async def main() -> int:
    ...
    log_file_path = output_dir / f"gleaner_sitemap_discovery_{date_range_str}_{timestamp}.log"
    ...
    success_path = output_dir / f"gleaner_sitemap_discovery_{date_range_str}_{timestamp}.jsonl"
    failures_path = output_dir / f"gleaner_sitemap_discovery_{date_range_str}_{timestamp}-failures.jsonl"
